...
import net.mcreator.strangefuelsmod.procedure.ProcedureGensokyochuansong;
...
public class GuiJitan extends ElementsStrangeFuelsMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiJitan(ElementsStrangeFuelsMod instance) {
		super(instance, 343);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 10, 31) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemGensokyo.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 54, 31) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemGensokyo.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 151, 31) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemGensokyo.block, (int) (1)).getItem() == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 107, 31) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (new ItemStack(ItemGensokyo.block, (int) (1)).getItem() == stack.getItem());
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("strangefuelsmod:textures/jitan.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 18, this.guiTop + 53, 140, 20, "Enter Gensokyo"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureGensokyochuansong.executeProcedure($_dependencies);
			}
		}
	}
