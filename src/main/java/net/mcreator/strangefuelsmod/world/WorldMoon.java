...
import net.mcreator.strangefuelsmod.item.ItemMoon;
import net.mcreator.strangefuelsmod.block.BlockMoonturf;
import net.mcreator.strangefuelsmod.block.BlockMoonrock;
import net.mcreator.strangefuelsmod.block.BlockGemquartzblock;
...
public class WorldMoon extends ElementsStrangeFuelsMod.ModElement {
	public static int DIMID = 6;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("strangefuelsmod:moon_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;
	public WorldMoon(ElementsStrangeFuelsMod instance) {
		super(instance, 412);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemMoon().setUnlocalizedName("moon").setRegistryName("moon"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemMoon.block, 0, new ModelResourceLocation("strangefuelsmod:moon", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11),
									flag ? BlockGemquartzblock.block.getDefaultState().getBlock().getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
			}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12),
								flag1 ? BlockGemquartzblock.block.getDefaultState().getBlock().getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("moon_portal");
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != BlockGemquartzblock.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == BlockGemquartzblock.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != BlockGemquartzblock.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != BlockGemquartzblock.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = BlockMoonrock.block.getDefaultState();
		private static final IBlockState STONE2 = BlockMoonturf.block.getDefaultState();
		private static final IBlockState FLUID = BlockMoonturf.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("strangefuelsmod:moonbiome")),};
