...
public class ProcedureZhushijietangguoFoodEaten extends ElementsStrangeFuelsMod.ModElement {
	public ProcedureZhushijietangguoFoodEaten(ElementsStrangeFuelsMod instance) {
		super(instance, 321);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure ZhushijietangguoFoodEaten!");
			return;
		}
