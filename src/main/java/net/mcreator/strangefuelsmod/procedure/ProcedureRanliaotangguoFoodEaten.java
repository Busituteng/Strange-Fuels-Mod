...
public class ProcedureRanliaotangguoFoodEaten extends ElementsStrangeFuelsMod.ModElement {
	public ProcedureRanliaotangguoFoodEaten(ElementsStrangeFuelsMod instance) {
		super(instance, 309);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure RanliaotangguoFoodEaten!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (!entity.world.isRemote && !entity.isRiding() && !entity.isBeingRidden() && entity instanceof EntityPlayerMP) {
			int dimensionID = WorldRanliaoweidu.DIMID;
