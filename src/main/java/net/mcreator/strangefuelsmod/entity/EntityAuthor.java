...
import net.mcreator.strangefuelsmod.procedure.ProcedureAuthorEntityIsHurt;
import net.mcreator.strangefuelsmod.procedure.ProcedureAuthorEntityDies;
import net.mcreator.strangefuelsmod.ElementsStrangeFuelsMod;

@ElementsStrangeFuelsMod.ModElement.Tag
public class EntityAuthor extends ElementsStrangeFuelsMod.ModElement {
	public static final int ENTITYID = 24;
	public static final int ENTITYID_RANGED = 25;
	public EntityAuthor(ElementsStrangeFuelsMod instance) {
		super(instance, 425);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("strangefuelsmod", "author"), ENTITYID).name("author").tracker(32, 3, true).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("strangefuelsmod:textures/author.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(3, new EntityAIWander(this, 0.9));
			this.tasks.addTask(4, new EntityAITempt(this, 1.2, new ItemStack(Blocks.END_ROD, (int) (1)).getItem(), false));
		...
		protected Item getDropItem() {
			return new ItemStack(Blocks.END_ROD, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureAuthorEntityIsHurt.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			{
				java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
				ProcedureAuthorEntityDies.executeProcedure($_dependencies);
			}
		}
