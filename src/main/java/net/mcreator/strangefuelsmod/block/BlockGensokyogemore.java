...
import net.mcreator.strangefuelsmod.item.ItemGensokyogem;
...
public class BlockGensokyogemore extends ElementsStrangeFuelsMod.ModElement {
	@GameRegistry.ObjectHolder("strangefuelsmod:gensokyogemore")
	public static final Block block = null;
	public BlockGensokyogemore(ElementsStrangeFuelsMod instance) {
		super(instance, 389);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("gensokyogemore"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("strangefuelsmod:gensokyogemore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("gensokyogemore");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemGensokyogem.block, (int) (1)));
		}
	}
}
