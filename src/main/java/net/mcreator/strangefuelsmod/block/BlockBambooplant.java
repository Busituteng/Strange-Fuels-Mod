...
public class BlockBambooplant extends ElementsStrangeFuelsMod.ModElement {
	@GameRegistry.ObjectHolder("strangefuelsmod:bambooplant")
	public static final Block block = null;
	public BlockBambooplant(ElementsStrangeFuelsMod instance) {
		super(instance, 336);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("strangefuelsmod:bambooplant", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("bambooplant");
			setRegistryName("bambooplant");
		}
